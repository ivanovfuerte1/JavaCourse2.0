...
public class QuickSort extends ArrayMedian {
	...
	private void quicksort(int left, int right) {
		int i = left;
		int j = right;
		// The pivot is chosen to be the median amongst the first, middle and last element
	...
	/**
	 * Swaps the values when they are not in the correct place. It means values smaller than the
	 * pivot should stay on its left and greater values on its right in an array presented as a
