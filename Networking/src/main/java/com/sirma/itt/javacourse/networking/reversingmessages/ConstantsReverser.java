...
public enum ConstantsReverser {
	...
	public static final String SEND_BUTTON_LABEL = "Reverse message";
	public static final String CLIENT_WINDOW_LABEL = "Client Reverser";
	...
	public static final int COMPONENT_WIDTH = 290;
	public static final int WINDOW_X_POSITION = 100;
	public static final int CLIENT_WINDOW_Y_POSITION = 100;
